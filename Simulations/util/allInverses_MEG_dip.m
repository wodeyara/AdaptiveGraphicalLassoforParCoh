...
% leadField  and returns inverses
% for all percentiles from 1:91 in the matrix allInv. 
...
L = leadField * weightingMatrix; % [channels x (dipoles*3)] * weighting matrix [(dipoles*3) x channels]
